...
// TR Nut trap
   // Hole for the nut
    translate(v=[0,-17, -1]) poly_cylinder(h = 9.01, r = 5.45, $fn = 25);
    translate(v=[0,-17, -0.1]) cylinder(h = 0.5, r1 = 5.25+0.8,r2 = 5.45, $fn = 25);

// Screw holes for TR nut
    translate(v=[0,-17, 0]) rotate([0, 0, -135]) translate([0, 8, -1]) cylinder(h = 10, r = 1.6, $fn=25);
    translate(v=[0,-17, 0]) rotate([0, 0, -135]) translate([0, -8, -1]) cylinder(h = 10, r = 1.6, $fn=25);
